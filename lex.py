...
# === CI-3725
# === Funcion: Analizador lexicografico del lenguaje GuardedUSB
# === Autores:
...
tokens = list(reservadas.values())+ ['TkOBlock','TkCBlock','TkSoForth', 'TkComma',
         ...
         'TkCBracket', 'TkTwoPoints', 'TkTwoPoints' , 'TkConcat', 'TkNum','TkId', 'TkUminus', 'TkConditional','TkComments']
...
# Ignoramos espacios y tabs ( Faltan saltos de linea y comentarios)
t_ignore  = ' \t'
#t_ignore_jumpLine = r'\n'
